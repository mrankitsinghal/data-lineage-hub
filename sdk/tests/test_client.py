...
from data_lineage_hub_sdk.client import LineageHubClient, TelemetryClient, APIError, BatchingLineageClient
from data_lineage_hub_sdk.config import configure, reset_config
from data_lineage_hub_sdk.models import LineageIngestResponse, TelemetryIngestResponse
...
def mock_httpx_client():
    ...
    with patch('data_lineage_hub_sdk.client.httpx.AsyncClient') as mock:
        yield mock
...
class TestLineageHubClient:
    ...
    async def test_send_telemetry_data_success(self, lineage_client, mock_httpx_client):
        ...
        result = await lineage_client.send_telemetry_data(traces=traces, metrics=metrics)
    ...
    async def test_api_error_handling(self, lineage_client, mock_httpx_client):
        ...
        mock_instance.post.return_value.raise_for_status.side_effect = httpx.HTTPStatusError(
