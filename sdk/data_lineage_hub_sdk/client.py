...
class LineageHubClient:
    ...
    def __init__(
        ...
        config: Optional[LineageHubConfig] = None,
    ):
        """
    ...
    async def send_telemetry_data(
        ...
        try:
            ...
            if result.errors:
                logger.warning("Some telemetry data was rejected", errors=result.errors[:5])
...
class BatchingLineageClient:
    ...
    def __init__(
        self,
        base_client: Optional[LineageHubClient] = None,
        batch_size: int = 100,
    ...
    async def flush(self):
        ...
        try:
            ...
            logger.exception("Error flushing events", error=str(e), event_count=len(events_to_send))
