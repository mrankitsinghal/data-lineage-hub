...
class TelemetryData(BaseModel):
    ...
    traceId: Optional[str] = Field(default=None, description="Trace identifier")
    spanId: Optional[str] = Field(default=None, description="Span identifier") 
    resource: Dict[str, Any] = Field(description="Resource attributes")
    attributes: Optional[Dict[str, Any]] = Field(default=None, description="Span/metric attributes")
...
class LineageIngestRequest(BaseModel):
    ...
    source: Optional[str] = Field(default="data-lineage-hub-sdk", description="Source system identifier")
...
class TelemetryIngestRequest(BaseModel):
    ...
    traces: List[Dict[str, Any]] = Field(default_factory=list, description="List of trace spans")
    metrics: List[Dict[str, Any]] = Field(default_factory=list, description="List of metrics")
    source: Optional[str] = Field(default="data-lineage-hub-sdk", description="Source system identifier")
...
class DatasetReference(BaseModel):
    ...
    facets: Optional[Dict[str, Any]] = Field(default=None, description="Dataset facets")
...
class JobReference(BaseModel):
    ...
    facets: Optional[Dict[str, Any]] = Field(default=None, description="Job facets")
...
class RunReference(BaseModel):
    ...
    facets: Optional[Dict[str, Any]] = Field(default=None, description="Run facets")
...
class MetricPoint(BaseModel):
    ...
    timestamp: str = Field(description="ISO 8601 timestamp")
    attributes: Optional[Dict[str, str]] = Field(default=None, description="Metric attributes")
...
class SpanData(BaseModel):
    ...
    parentSpanId: Optional[str] = Field(default=None, description="Parent span identifier")
    ...
    links: Optional[List[Dict[str, Any]]] = Field(default=None, description="Span links")
    resource: Dict[str, Any] = Field(description="Resource attributes")